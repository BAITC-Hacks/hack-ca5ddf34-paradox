...
function openSelection(product) {
  ...
  $('multipleHint').textContent = multiple === null ? 'Кратность заказа не распознана. Уточните её в чате.' : `Кратность заказа: ${fmt(multiple)}. Наличие и цена будут проверены сервером.`;
